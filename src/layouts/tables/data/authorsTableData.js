...
export default function dataa() {
  ...
  return {
    columns: [
      ...
      { Header: "sale period", accessor: "saleType", align: "center" },
      { Header: "last claim date", accessor: "lastClaimedDate", align: "center" },
      { Header: "remaining claim", accessor: "remaningClaim", align: "center" },
